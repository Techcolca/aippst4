...
const resources = {
  fr: {
    translation: {
      ...
      integrations: "Agents IA de Base",
      ...
      website_context_integration: "Agent IA de Base du contexte du site web",
      ...
      // Documentation: Agents vs Chatbots
      "documentation.agents_vs_chatbots.title": "Agents IA de Base vs Chatbots Traditionnels",
      "documentation.agents_vs_chatbots.introduction": "Comprendre la différence entre nos Agents IA de Base et les chatbots traditionnels",
      "documentation.agents_vs_chatbots.what_are_basic_agents": "Que sont les Agents IA de Base ?",
      "documentation.agents_vs_chatbots.basic_agent_description": "Nos Agents IA de Base ne sont pas de simples chatbots. Ce sont des systèmes d'IA qui comprennent spécifiquement votre entreprise, votre contenu et vos objectifs commerciaux. Ils offrent des interactions naturelles avec une compréhension contextuelle avancée.",
      "documentation.agents_vs_chatbots.key_differences": "Différences Clés",
      "documentation.agents_vs_chatbots.context_understanding": "Compréhension Contextuelle",
      "documentation.agents_vs_chatbots.context_description": "Comprennent le contexte de votre entreprise et de votre site web pour des réponses personnalisées",
      "documentation.agents_vs_chatbots.memory_persistence": "Mémoire Persistante",
      "documentation.agents_vs_chatbots.memory_description": "Mémorisent les conversations précédentes pour des interactions plus naturelles",
      "documentation.agents_vs_chatbots.automatic_analysis": "Analyse Automatique",
      "documentation.agents_vs_chatbots.analysis_description": "Analysent automatiquement les besoins des utilisateurs et ajustent leurs réponses",
      "documentation.agents_vs_chatbots.business_integration": "Agent IA de Base Commercial",
      "documentation.agents_vs_chatbots.integration_description": "Fonctionnent parfaitement comme Agents IA de Base avec vos processus et objectifs commerciaux",
      "documentation.agents_vs_chatbots.upgrade_path": "Évolution vers des Agents Avancés",
      "documentation.agents_vs_chatbots.upgrade_description": "Nos Agents de Base peuvent évoluer vers des systèmes d'automatisation avancés avec analyse professionnelle.",
      ...
      loading: "Chargement...",
      back: "Retour",
      edit_integration: "Modifier l'Agent IA de Base",
      ...
      view_all_conversations_for_integration: "Voir toutes les conversations pour cet Agent IA de Base",
      search_conversations: "Rechercher des conversations",
      
      // Analytics
      analytics_description: "Analyse détaillée des performances et métriques",
      integration_performance: "Performance de l'Agent IA de Base",
      ...
      "features.detailedDescription": "AIPPS offre une suite complète d'outils d'IA conversationnelle conçus pour transformer la façon dont vos visiteurs interagissent avec votre site web. De l'automatisation simple aux Agents IA de Base complexes, nous avons tout ce qu'il vous faut.",
      ...
      "features.conversationalAI.title": "Agents IA de Base",
      "features.conversationalAI.description": "Agents IA qui comprennent votre entreprise pour des interactions naturelles",
      ...
      "features.easyIntegration.title": "Agent IA de Base Facile",
      "features.easyIntegration.description": "Configurez facilement vos Agents IA de Base avec vos systèmes existants",
      ...
      "help.categories.configuration.article3": "Gérer les Agents IA de Base",
      "help.categories.configuration.article4": "Options avancées",
      "help.categories.integration.title": "Agent IA de Base",
      "help.categories.integration.description": "Connecter AIPPS à vos outils",
      "help.categories.integration.article1": "API et webhooks",
      "help.categories.integration.article2": "Agent IA de Base WordPress",
      "help.categories.integration.article3": "Code d'Agent IA de Base",
      "help.categories.integration.article4": "Tests d'Agent IA de Base",
      ...
      "documentation.widget_integration": "Agent IA de Base widget",
      ...
      "documentation.hosting_requirements": "Exigences d'hébergement",
      ...
      "forms.ai_integration": "Agent IA de Base",
      "forms.ai_integration_desc": "Agent IA de Base aux formulaires",
      ...
      "forms.advanced_config_desc": "Paramètres experts et Agents IA de Base",
      ...
      "forms.integration_methods": "Méthodes d'Agent IA de Base",
      ...
      "forms.get_code_desc": "Copiez le code d'Agent IA de Base généré",
      ...
      "forms.analytics_integration": "Agent IA de Base analytics",
      ...
      "forms.widget_integration": "Agent IA de Base widget",
      "forms.widget_integration_desc": "Formulaires d'Agent IA de Base au chat",
      ...
      "implementation.isolated_stats": "Statistiques détaillées par Agent IA de Base",
      ...
      "getStartedPage.widget.step2.dashboard_steps.1": "Sélectionnez l'Agent IA de Base que vous souhaitez configurer",
      ...
      "getStartedPage.buttons.go_to_integrations": "Aller aux Agents IA de Base",
      ...
      "getStartedPage.form.step3.dashboard_steps": [
        ...
        "Sélectionnez l'Agent IA de Base que vous souhaitez configurer",
      ...
      "getStartedPage.ignored_sections.step_2": "Ajoutez-les dans les paramètres d'Agent IA de Base",
      ...
      "pricing.contact_us": "Pré-analyse gratuite",
      ...
      "view_performance_metrics_for_integration": "Voir les métriques de performance pour l'Agent IA de Base",
      ...
      automation_analysis: {
        ...
        make_pro2: "Nombreux Agents IA de Base",
        ...
        custom_pro6: "Intégration avec +50 systèmes (APIs, Slack, GitHub, Stripe, etc.)",
        ...
        custom_ideal: "Idéal pour: Tout type d'entreprises (PME, moyennes, grandes) et besoins: facturation, inventaire, CRM, workflows, Agents IA de Base complexes",
        ...
        make_pro_2: "Nombreux Agents IA de Base",
        ...
        custom_pro_6: "Intégration avec +50 systèmes (APIs, Slack, GitHub, Stripe, etc.)",
        ...
        experience_intermediate: "Oui, automatisation intermédiaire (flux de travail, Agents IA de Base)",
  ...
  es: {
    translation: {
      ...
      integrations: "Agentes de IA Básicos",
      ...
      website_context_integration: "Agente de IA Básico del contexto del sitio web",
      ...
      // Documentation: Agents vs Chatbots
      "documentation.agents_vs_chatbots.title": "Agentes de IA Básicos vs Chatbots Tradicionales",
      "documentation.agents_vs_chatbots.introduction": "Comprende la diferencia entre nuestros Agentes de IA Básicos y los chatbots tradicionales",
      "documentation.agents_vs_chatbots.what_are_basic_agents": "¿Qué son los Agentes de IA Básicos?",
      "documentation.agents_vs_chatbots.basic_agent_description": "Nuestros Agentes de IA Básicos no son simples chatbots. Son sistemas de IA que comprenden específicamente tu negocio, tu contenido y tus objetivos comerciales. Ofrecen interacciones naturales con comprensión contextual avanzada.",
      "documentation.agents_vs_chatbots.key_differences": "Diferencias Clave",
      "documentation.agents_vs_chatbots.context_understanding": "Comprensión Contextual",
      "documentation.agents_vs_chatbots.context_description": "Comprenden el contexto de tu negocio y sitio web para respuestas personalizadas",
      "documentation.agents_vs_chatbots.memory_persistence": "Memoria Persistente",
      "documentation.agents_vs_chatbots.memory_description": "Recuerdan conversaciones anteriores para interacciones más naturales",
      "documentation.agents_vs_chatbots.automatic_analysis": "Análisis Automático",
      "documentation.agents_vs_chatbots.analysis_description": "Analizan automáticamente las necesidades de los usuarios y ajustan sus respuestas",
      "documentation.agents_vs_chatbots.business_integration": "Agente de IA Básico Empresarial",
      "documentation.agents_vs_chatbots.integration_description": "Funcionan perfectamente como Agentes de IA Básicos con tus procesos y objetivos comerciales",
      "documentation.agents_vs_chatbots.upgrade_path": "Evolución hacia Agentes Avanzados",
      "documentation.agents_vs_chatbots.upgrade_description": "Nuestros Agentes Básicos pueden evolucionar hacia sistemas de automatización avanzados con análisis profesional.",
      ...
      loading: "Cargando...",
      back: "Atrás",
      edit_integration: "Editar Agente de IA Básico",
      ...
      view_all_conversations_for_integration: "Ver todas las conversaciones para este Agente de IA Básico",
      search_conversations: "Buscar conversaciones",
      
      // Analytics
      analytics_description: "Análisis detallado de rendimiento y métricas",
      integration_performance: "Rendimiento del Agente de IA Básico",
      ...
      "features.conversationalAI.title": "Agentes de IA Básicos",
      "features.conversationalAI.description": "Agentes de IA que comprenden tu negocio para interacciones naturales",
      ...
      "features.easyIntegration.title": "Agente de IA Básico Fácil",
      "features.easyIntegration.description": "Configura fácilmente tus Agentes de IA Básicos con tus sistemas existentes",
      ...
      "help.categories.integration.title": "Agente de IA Básico",
      ...
      "help.categories.integration.article2": "Agente de IA Básico con WordPress",
      "help.categories.integration.article3": "Código de Agente de IA Básico",
      "help.categories.integration.article4": "Pruebas de Agente de IA Básico",
      ...
      "documentation.widget_integration": "Agente de IA Básico widget",
      ...
      "documentation.hosting_requirements": "Requisitos de hosting",
      ...
      "forms.ai_integration": "Agente de IA Básico",
      "forms.ai_integration_desc": "Agente de IA Básico en formularios",
      ...
      "forms.integration_methods": "Métodos de Agente de IA Básico",
      ...
      "forms.get_code_desc": "Copia el código de Agente de IA Básico generado",
      ...
      "forms.analytics_integration": "Agente de IA Básico analytics",
      ...
      "forms.widget_integration": "Agente de IA Básico widget",
      "forms.widget_integration_desc": "Formularios de Agente de IA Básico en chat",
      ...
      "implementation.isolated_stats": "Estadísticas detalladas por Agente de IA Básico",
      ...
      "getStartedPage.widget.step2.dashboard_steps.1": "Selecciona el Agente de IA Básico que quieres configurar",
      ...
      "getStartedPage.buttons.go_to_integrations": "Ir a Agentes de IA Básicos",
      ...
      "getStartedPage.form.step3.dashboard_steps": [
        ...
        "Selecciona el Agente de IA Básico que quieres configurar",
      ...
      "getStartedPage.ignored_sections.step_2": "Agrégalos en la configuración de Agente de IA Básico",
      ...
      "pricing.contact_us": "Pre análisis gratuito",
      ...
      "view_performance_metrics_for_integration": "Ver métricas de rendimiento para el Agente de IA Básico",
      ...
      automation_analysis: {
        ...
        custom_pro6: "Integración con +50 sistemas (APIs, Slack, GitHub, Stripe, etc.)",
  ...
  en: {
    translation: {
      ...
      website_context_integration: "Basic AI Agent website context",
      ...
      // Documentation: Agents vs Chatbots
      "documentation.agents_vs_chatbots.title": "Basic AI Agents vs Traditional Chatbots",
      "documentation.agents_vs_chatbots.introduction": "Understand the difference between our Basic AI Agents and traditional chatbots",
      "documentation.agents_vs_chatbots.what_are_basic_agents": "What are Basic AI Agents?",
      "documentation.agents_vs_chatbots.basic_agent_description": "Our Basic AI Agents are not simple chatbots. They are AI systems that specifically understand your business, your content, and your commercial objectives. They offer natural interactions with advanced contextual understanding.",
      "documentation.agents_vs_chatbots.key_differences": "Key Differences",
      "documentation.agents_vs_chatbots.context_understanding": "Contextual Understanding",
      "documentation.agents_vs_chatbots.context_description": "Understand your business and website context for personalized responses",
      "documentation.agents_vs_chatbots.memory_persistence": "Persistent Memory",
      "documentation.agents_vs_chatbots.memory_description": "Remember previous conversations for more natural interactions",
      "documentation.agents_vs_chatbots.automatic_analysis": "Automatic Analysis",
      "documentation.agents_vs_chatbots.analysis_description": "Automatically analyze user needs and adjust their responses",
      "documentation.agents_vs_chatbots.business_integration": "Business Basic AI Agent",
      "documentation.agents_vs_chatbots.integration_description": "Seamlessly work with your business processes and objectives as Basic AI Agents",
      "documentation.agents_vs_chatbots.upgrade_path": "Evolution to Advanced Agents",
      "documentation.agents_vs_chatbots.upgrade_description": "Our Basic Agents can evolve into advanced automation systems with professional analysis.",
      ...
      loading: "Loading...",
      back: "Back",
      edit_integration: "Edit Basic AI Agent",
      ...
      view_all_conversations_for_integration: "View all conversations for this Basic AI Agent",
      search_conversations: "Search conversations",
      
      // Analytics
      analytics_description: "Detailed performance and metrics analysis",
      integration_performance: "Basic AI Agent performance",
      ...
      "features.detailedDescription": "AIPPS offers a complete suite of conversational AI tools designed to transform how your visitors interact with your website. From simple automation to complex Basic AI Agents, we have everything you need.",
      ...
      "features.advanced.customization.feature3": "Flexible API Basic AI Agent",
      "features.conversationalAI.title": "Basic AI Agents",
      "features.conversationalAI.description": "AI agents that understand your business for natural interactions",
      "features.taskAutomation.title": "Task Automation",
      "features.taskAutomation.description": "Automate your repetitive processes",
      "features.easyIntegration.title": "Easy Basic AI Agent",
      ...
      "terms.services.item2": "Basic AI Agent chat widget",
      ...
      "help.categories.configuration.article3": "Manage Basic AI Agents",
      "help.categories.configuration.article4": "Advanced options",
      "help.categories.integration.title": "Basic AI Agent",
      ...
      "help.categories.integration.article2": "WordPress Basic AI Agent",
      "help.categories.integration.article3": "Basic AI Agent code",
      "help.categories.integration.article4": "Basic AI Agent testing",
      ...
      "documentation.widget_integration": "Basic AI Agent widget",
      ...
      "documentation.hosting_requirements": "Hosting requirements",
      ...
      "documentation.overview.solution_point_2": "Easy Basic AI Agent setup in minutes",
      ...
      "forms.ai_integration": "Basic AI Agent",
      "forms.ai_integration_desc": "Basic AI Agent in forms",
      ...
      "forms.analytics_integration": "Basic AI Agent analytics",
      ...
      "forms.widget_integration": "Basic AI Agent widget",
      "forms.widget_integration_desc": "Forms with Basic AI Agent in chat",
      ...
      "implementation.isolated_stats": "Detailed statistics per Basic AI Agent",
      ...
      "getStartedPage.widget.step2.dashboard_steps.1": "Select the Basic AI Agent you want to configure",
      ...
      "getStartedPage.buttons.go_to_integrations": "Go to Basic AI Agents",
      ...
      "getStartedPage.form.step3.dashboard_steps": [
        ...
        "Select the Basic AI Agent you want to configure",
      ...
      "getStartedPage.ignored_sections.step_2": "Add them in Basic AI Agent settings",
      ...
      "getStartedPage.fullscreen.step5.feature_3": "CRM Basic AI Agent",
      ...
      "pricing.contact_us": "Free Pre-analysis",
      ...
      "view_performance_metrics_for_integration": "View performance metrics for Basic AI Agent",
      ...
      automation_analysis: {
        ...
        make_pro2: "Many Basic AI Agents",
        ...
        custom_pro6: "Integration with +50 systems (APIs, Slack, GitHub, Stripe, etc.)",
        ...
        custom_ideal: "Ideal for: All types of companies (SMEs, medium, large) and needs: billing, inventory, CRM, workflows, complex Basic AI Agents",
        ...
        make_pro_2: "Numerous Basic AI Agents",
        ...
        experience_intermediate: "Yes, intermediate automation (workflows, Basic AI Agents)",
