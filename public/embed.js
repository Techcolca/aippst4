(function() {
  ...
  async function loadWidgetConfig() {
    ...
    try {
      ...
      // Actualizar el texto del botón después de cargar la configuración
      updateButtonText();
  ...
  function createWidgetDOM() {
    ...
    if (config.widgetType === 'fullscreen') {
      ...
      fullscreenButton.innerHTML = `
        ...
        <div class="aipi-fullscreen-button-text">' + (config.integrationName || config.assistantName) + '</div>
      `;
    ...
    widgetInstance.innerHTML = `
      ...
      <button id="aipi-toggle-button">
        ...
        <span class="aipi-button-text">' + (config.integrationName || config.assistantName) + '</span>
      </button>
    `;
